...
# PR creation is part of Phase 3.5 and uses the installed GitHub CLI (`gh`).
```
...
- When presenting a plan, pair every step's **technical action** with the
  **plain-language function or result** it delivers.
- When execution is ready for approval, report the **user-visible outcome**,
  **changed files and reasons**, **validation and results**, and any
  **unresolved issues or uncertainty**. Keep the report concise.
...
If task bookkeeping is complete, continue the authorized GitHub flow in Phase 3.5; if dirty, return to Phase 3.4 first.
[/workflow-state:completed]
